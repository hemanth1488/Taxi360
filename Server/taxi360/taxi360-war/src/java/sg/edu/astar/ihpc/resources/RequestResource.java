...
public class RequestResource {
    ...
    @GET
    @Path("range")
    public RequestDensity[] findRequestsPerDirection(@QueryParam("clat") Double cLat, @QueryParam("clog") Double cLog, 
    @QueryParam("minlat") Double minLat, @QueryParam("minlog") Double minLog, 
    @QueryParam("maxlat") Double maxLat, @QueryParam("maxlog") Double maxLog, 
    @QueryParam("radius") Double radius) {
        return requestEJB.findRequestsPerQuarter(new Location(cLat, cLog), new Location(minLat, minLog), new Location(maxLat, maxLog), radius);
    }
