...
public class Server {
	...
	private void getRequest(String url) throws Exception{
		...
		try{
		httpGet.addHeader(AUTH_HEADER, SessionManager.getInstance().getPassenger().getAccesskey());}catch(Exception e){}
	...
	private void postRequest(String url) throws ClientProtocolException, IOException  {
		...
		try{
		httpPost.addHeader(AUTH_HEADER, SessionManager.getInstance().getPassenger().getAccesskey());}catch(Exception e){}
		if(isBody)
	...
	private void putRequest(String url) throws ClientProtocolException, IOException  {
		...
		try{
		httpPut.addHeader(AUTH_HEADER, SessionManager.getInstance().getPassenger().getAccesskey());}catch(Exception e){}
		if(isBody)
	...
	private void deleteRequest(String url) throws ClientProtocolException, IOException{
		...
		try{
		httpDelete.addHeader(AUTH_HEADER, SessionManager.getInstance().getPassenger().getAccesskey());}catch(Exception e){}
